...
@OnlyIn(Dist.CLIENT)
public class FurnaceManaitaScreen extends AbstractContainerScreen<ManaitaFurnaceMenu> implements RecipeUpdateListener {
    private static final ResourceLocation FURNACE_LOCATION = ResourceLocation.withDefaultNamespace("textures/gui/container/furnace.png");
    ...
    private final SmeltingRecipeBookComponent recipeBookComponent = new SmeltingRecipeBookComponent();
    ...
    protected void init() {
        ...
        this.addRenderableWidget(new ImageButton(this.leftPos + 20, this.height / 2 - 49, 20, 18, RECIPE_BUTTON_SPRITES, (button) -> {
    ...
    protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
        ...
        guiGraphics.drawString(this.font, doubling_text, 118, 22, 4210752);
    }
    ...
    protected void renderBg(GuiGraphics guiGraphics, float partialTick, int mouseX, int mouseY) {
        ...
        guiGraphics.blit(FURNACE_LOCATION, i, j, 0, 0, this.imageWidth, this.imageHeight);
    }
